...
# display on console
things_returned = print('hello world')
print(things_returned)


# input function to obtain answers to simple questions
# # example 1
# user_input = input("please enter a number: ")
# print(type(user_input)) # input() always return a string
# print('square of the number is', float(user_input)**2)
